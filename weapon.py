...
class Weapon(AnimatedSprite):
    def __init__(self, game, path='resources/sprites/weapon/shotgun/0.bmp', scale=0.3, animation_time=90):
        super().__init__(game=game, path=path, scale=scale, animeted_time=animation_time)
